				...
				<div class="table-responsive">
					...
					<td><c:out value="${consultation.rdv.patient.fnamepat}"/></td>
						<td><c:out value="${consultation.rdv.patient.lnamepat}"/></td>
							...
							<td><a href="/affichercert/${idMedecin}/${idSec}/${consultation.rdv.idRdv}/${consultation.rdv.patient.idPatient}/${consultation.idCons}">afficher certificat</a></td>
							<td><a href="/afficherord/${idMedecin}/${idSec}/${consultation.rdv.idRdv}/${consultation.rdv.patient.idPatient}/${consultation.idCons}">afficher ordonnance</a></td>	
