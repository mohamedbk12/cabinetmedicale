...
<div class="container" id="homeDiv">
			...
			<div class="container" id="choi">
				<div class="jumbotron text-center">
					<h3><a href="/listpatientsec/${idMedecin}/${idSec}" class="btn btn-primary">liste des patient</a>
					    <a href="/ajoutpatsec/${idMedecin}/${idSec}" class="btn btn-primary">ajouter patient</a>  
					    <a href="/listrdvsec/${idMedecin}/${idSec}" class="btn btn-primary">liste des rendez-vous</a> 
					<a href="/listconsultationsec/${idMedecin}/${idSec}" class="btn btn-primary">la liste des consultation</a>
					<a href="/listmsgrecu/${idMedecin}/${idSec}" class="btn btn-primary"> les message recue</a>
					<a href="/listmsgenvoisec/${idMedecin}/${idSec}" class="btn btn-primary"> les message envoyer</a>
