...
<div class="container" id="homeDiv">
			...
			<div class="container" id="choi">
				<div class="jumbotron text-center">
					<h3><a href="/msgenvoi/${idPatient}" class="btn btn-primary btn-lg btn-block">message envoyer</a>
					    <a href="/listmsgerec/${idPatient}" class="btn btn-primary btn-lg btn-block">message recue(${m })</a>  
					</h3>
				</div>
			</div>
